...
const ConsentDocument = props => {
  return (
    <div id="ConsentContainer">
      ...
      <p>
        <strong>Anonymized</strong>, Affiliation
      </p>

      <h3>Research Team</h3>
      <ul>
        <li>Anonymized, Affiliation</li>
        <li>Anonymized, Affiliation</li>
        <li>Anonymized, Affiliation</li>
        <li>Anonymized, Affiliation</li>
        <li>Anonymized, Affiliation</li>
      ...
      <p>Principal Investigator: Anonymized</p>
      <p>Email: email@email.com</p>
      <p>Phone: PHONENUMBER</p>
      <p>
        As part of their review, the INSTITUTION Institutional Review Board Health Sciences and Behavioral Sciences has
        determined that this study is no more than minimal risk and exempt from ongoing IRB oversight.
      </p>
    </div>
  );
};
