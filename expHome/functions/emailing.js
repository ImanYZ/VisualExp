        ...
        setTimeout(async () => {
          const mailOptions = {
            ...
            html: `<p>Hello ${(administratorData.howToAddress || "")
              ...
              <p></p>
              <p>We have developed an online platform for collaborative learning and research, called 1Cademy (more information <a href="https://1cademy.us" target="_blank">on this page</a>). Since Fall 2020, out of more than 10,000 students who applied, 1,490 talented students from 144 schools have joined 1Cademy to collaboratively summarize, visualize, and present books and research papers on a weekly basis and get constructive feedback about their research. You can check out <a href="https://1cademy.us/#CommunitiesSection" target="_blank">our existing research communities</a> and search through <a href="https://node.1cademy.us" target="_blank">the 1Cademy Knowledge Graph</a> to learn more about the content generated by students. We also have community leadership opportunities for qualified students to lead our existing communities or establish new research communities.</p>
              <p></p>
              <p>${
                administratorData.country === "🇺🇸 United States;US"
                  ...
                  : ""
              }We would like to ask if you can kindly inform your students about our online research opportunities, so they can apply through <a href="https://1cademy.us" target="_blank">the 1Cademy homepage</a>.</p>
        ...
        setTimeout(async () => {
          const mailOptions = {
            ...
            html: `<p>Hello ${
              ...
              <p></p>
              <p>We are a research group at the University of Michigan, School of Information, who have developed an online platform for collaborative learning and research, called 1Cademy (more information <a href="https://1cademy.us" target="_blank">on this page</a>). So far, out of more than 10,000 students who applied, 1,490 talented students from 144 schools have joined 1Cademy to collaboratively summarize, visualize, and present books and research papers. You can ${
                instructorData.GoogleScholar
                  ? 'check out <a href="https://1cademy.us/#CommunitiesSection" target="_blank">our existing research communities and their accomplishments</a> and '
                  : ""
