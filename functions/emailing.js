      ...
      if (
        ...
        setTimeout(async () => {
          const mailOptions = {
            ...
            html: `<p>Hello ${instructorData.prefix + ". " + capitalizeFirstLetter(instructorData.lastname)},</p>
              <p></p>
              ${
              ...
              <p></p>
              <p>We are a research group at the University of Michigan, School of Information, who have developed an online platform for collaborative learning and research, called 1Cademy (more information <a href="https://1cademy.com" target="_blank">on this page</a>). So far, out of 10,000 students who applied, more than 1,600 talented students from 183 schools have joined 1Cademy to collaboratively summarize, visualize, improve, and present our notes from books and research papers. You can ${
                instructorData.GoogleScholar
